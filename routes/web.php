...
Route::group(['namespace'=>'Wechat','middleware'=>'web'],function () {
    ...
    Route::get('/wechat/newslist', 'CommonController@newslist');
    Route::get('/wechat/smsinfo', 'CommonController@smsinfo');
    Route::get('/wechat/test', 'CommonController@test');
    Route::get('/wechat/userinfo', 'CommonController@userinfo');
